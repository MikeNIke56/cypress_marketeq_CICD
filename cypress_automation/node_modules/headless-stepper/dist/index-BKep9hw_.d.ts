...
type PolymorphicComponentType<C extends React.ElementType = React.ElementType> = C;

export type { PolymorphicComponentType as P, Steps as S, StepperOrientation as a, StepperContextType as b, StepperDirection as c };
