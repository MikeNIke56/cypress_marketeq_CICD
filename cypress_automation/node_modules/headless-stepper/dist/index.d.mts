...
import { S as Steps, a as StepperOrientation } from './index-BKep9hw_.mjs';
export { P as PolymorphicComponentType, b as StepperContextType, c as StepperDirection } from './index-BKep9hw_.mjs';
...
declare const useStepper: ({ orientation, ...rest }: StepperProps) => UseStepper;

declare const useIsomorphicId: () => string;

export { StepperOrientation, type StepperProps, type StepperState, Steps, type UseStepper, useIsomorphicId, useStepper };
