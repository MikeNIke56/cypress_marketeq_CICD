import { BookingCreateBody } from '../../../../features/bookings/lib/bookingCreateBodySchema';
import { BookingResponse } from '../../../../features/bookings/types';
import { ApiResponse, ApiErrorResponse, ApiSuccessResponse } from '../../../types/index.ts';
export type UseCreateBookingInput = BookingCreateBody & {
    locationUrl?: string;
};
...
export declare const useCreateBooking: ({ onSuccess, onError }?: IUseCreateBooking) => import('@tanstack/react-query').UseMutationResult<ApiResponse<{
    ...
    paymentUid?: string;
    paymentId?: number;
}>, Error, UseCreateBookingInput, unknown>;
export {};
