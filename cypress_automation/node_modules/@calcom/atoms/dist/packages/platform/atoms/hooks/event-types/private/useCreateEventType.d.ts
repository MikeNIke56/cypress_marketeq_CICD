import { CreateEventTypeInput_2024_06_14 } from '../../../../types/index.ts';
import { EventType } from '../../../../../kysely/types.ts';
export declare const QUERY_KEY = "use-create-event";
export type UseCreateEventTypeProps = {
    onSuccess?: (eventType: EventType) => void;
    onError?: (err: Error) => void;
    onSettled?: () => void;
};
export declare const useCreateEventType: ({ onSuccess, onError, onSettled }: UseCreateEventTypeProps) => import('@tanstack/react-query').UseMutationResult<{
    price: number;
    title: string;
    ...
    uuid: string | null;
}, Error, CreateEventTypeInput_2024_06_14, unknown>;
//# sourceMappingURL=useCreateEventType.d.ts.map