...
export declare const useAtomGetPublicEvent: ({ username, eventSlug, isTeamEvent, teamId, selectedDuration, }: Props) => import('@tanstack/react-query').UseQueryResult<{
    bookingFields: {
        name: string;
...
export {};
//# sourceMappingURL=useAtomGetPublicEvent.d.ts.map