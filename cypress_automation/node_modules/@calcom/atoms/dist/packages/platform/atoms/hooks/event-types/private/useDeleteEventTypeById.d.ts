export declare const QUERY_KEY = "use-delete-event-by-id";
export type UseDeleteEventTypeProps = {
    onSuccess?: () => void;
    onError?: (err: Error) => void;
    onSettled?: () => void;
};
export declare const useDeleteEventTypeById: ({ onSuccess, onError, onSettled }: UseDeleteEventTypeProps) => import('@tanstack/react-query').UseMutationResult<{
    price: number;
    title: string;
...
//# sourceMappingURL=useDeleteEventTypeById.d.ts.map