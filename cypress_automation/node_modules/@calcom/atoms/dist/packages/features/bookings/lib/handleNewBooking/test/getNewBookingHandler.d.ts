import { BookingHandlerInput } from '../../dto/types';
declare function handler(input: BookingHandlerInput): Promise<{
...
export declare function getNewBookingHandler(): typeof handler;
export {};
//# sourceMappingURL=getNewBookingHandler.d.ts.map