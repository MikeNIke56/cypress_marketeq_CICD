import { LocationObject } from '../../../app-store/locations';
...
export declare const getPublicEventSelect: (fetchAllUsers: boolean) => {
    id: true;
    title: true;
    description: true;
...
export declare function getEventTypeHosts({ hosts, fetchAllUsers, prisma, }: {
    hosts: Prisma.EventTypeGetPayload<{
...
export declare const getPublicEvent: (username: string, eventSlug: string, isTeamEvent: boolean | undefined, org: string | null, prisma: PrismaClient, fromRedirectOfNonOrgLink: boolean, currentUserId?: number, fetchAllUsers?: boolean) => Promise<{
    ...
    locations: (Pick<Partial<LocationObject>, "address" | "link" | "customLabel"> & Omit<LocationObject, "address" | "link" | "customLabel">)[];
    profile: {
    ...
    shouldMergePhoneSystemFields: boolean;
    ...
    workflows: ({
        workflow: {
            ...
            name: string;
            type: import('../../../kysely/types.ts').WorkflowType;
...
type Event = Prisma.EventTypeGetPayload<{
    select: typeof eventData;
}>;
type GetProfileFromEventInput = Omit<Event, "hosts"> & {
    hosts?: Event["hosts"];
    subsetOfHosts: Event["hosts"];
};
export declare function getProfileFromEvent(event: GetProfileFromEventInput): {
    username: string | null | undefined;
    name: string | null;
    weekStart: string;
    image: string;
...
export declare function getUsersFromEvent(event: Omit<Event, "owner" | "hosts"> & {
    owner: (Event["owner"] & {
        profile: UserProfile;
    }) | null;
...
export declare const processEventDataShared: ({ eventData, metadata, prisma, }: {
    eventData: Prisma.EventTypeGetPayload<{
        select: ReturnType<typeof getPublicEventSelect>;
    }>;
