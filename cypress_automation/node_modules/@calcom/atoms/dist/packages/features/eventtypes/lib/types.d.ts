import { ConnectedApps } from '../../../app-store/_utils/getConnectedApps';
import { EventLocationType } from '../../../app-store/locations';
import { eventTypeMetaDataSchemaWithTypedApps } from '../../../app-store/zod-utils';
import { TemplateType } from '../../calAIPhone/zod-utils';
import { ChildrenEventType } from './childrenEventType';
import { IntervalLimit } from '../../../lib/intervalLimits/intervalLimitSchema';
import { AttributesQueryValue } from '../../../lib/raqb/types';
import { EventTypeTranslation } from '../../../kysely/types.ts';
import { CancellationReasonRequirement, DisableCancelRescheduleScope, EventTypeAutoTranslatedField, MembershipRole, PeriodType, RRTimestampBasis, SchedulingType } from '../../../prisma/enums';
import { BookerLayoutSettings, CustomInputSchema, customInputSchema, EventTypeLocation, EventTypeMetadata, eventTypeBookingFields, eventTypeColor } from '../../../prisma/zod-utils';
import { RecurringEvent } from '@calcom/types/Calendar';
import { JsonValue } from '@calcom/types/Json';
import { UserProfile } from '@calcom/types/UserProfile';
import { z } from 'zod';
import { EventType } from './getEventTypeById';
