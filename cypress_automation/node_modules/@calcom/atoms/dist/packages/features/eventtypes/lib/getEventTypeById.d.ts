...
export declare const getEventTypeById: ({ currentOrganizationId, eventTypeId, userId, prisma, isTrpcCall, isUserOrganizationAdmin, userLocale, }: getEventTypeByIdProps) => Promise<{
    eventType: {
...
export declare function getRawEventType({ userId, eventTypeId, isUserOrganizationAdmin, currentOrganizationId, prisma, }: Omit<getEventTypeByIdProps, "isTrpcCall">): Promise<{
    schedule: {
        name: string;
        id: number;
    } | null;
...
//# sourceMappingURL=getEventTypeById.d.ts.map