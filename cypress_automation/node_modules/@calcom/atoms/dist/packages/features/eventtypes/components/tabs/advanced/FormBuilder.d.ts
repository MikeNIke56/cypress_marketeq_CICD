import { z } from 'zod';
import { fieldsSchema } from '../../../../form-builder/schema';
type RhfForm = {
 ...
 */
export declare const FormBuilder: ({ title, description, addFieldLabel, formProp, disabled, LockedIcon, dataStore, shouldConsiderRequired, showPriceField, paymentCurrency, showPhoneAndEmailToggle, isPlatform, }: {
    formProp: string;
    title: string;
    description: string;
